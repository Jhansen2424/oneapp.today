  ...
  return (
    <section className="relative overflow-hidden border-b border-white/[0.06] bg-[#0b0a10] pt-20">
      ...
      <div className="relative mx-auto grid min-h-[850px] max-w-[1380px] items-center gap-16 px-5 py-20 sm:px-8 lg:grid-cols-[.92fr_1.08fr] lg:py-24">
        <div>
          <motion.div initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }} className="mb-7 flex items-center gap-3"><span className="h-px w-8 bg-[#c153ff]" /><span className="font-mono text-[10px] font-bold uppercase tracking-[.22em] text-[#ce7bff]">The AI operating system for commerce growth</span></motion.div>
          <motion.h1 initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: .08 }} className="max-w-[720px] text-[clamp(3.6rem,7.2vw,7.1rem)] font-bold leading-[.86] tracking-[-.075em] text-white">See every signal.<br /><span className="bg-gradient-to-r from-[#d46fff] via-[#ad4bff] to-[#6e5cff] bg-clip-text text-transparent">Move every lever.</span></motion.h1>
